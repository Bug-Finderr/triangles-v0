              ...
              >
                ...
                <CardContent className="p-6 flex flex-col">
                  ...
                  <CardDescription className="text-left flex flex-col justify-center flex-grow">
                    ...
                    Nostrum nam eius nisi labore, optio officiis in accusantium
                    harum modi ad, sed incidunt?
                  </CardDescription>
                </CardContent>
              </Card>
            ))}
            ...
            <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
              ...
              <div className="flex flex-col justify-center w-full lg:w-1/2 text-center lg:text-left">
                ...
                <p className="text-sm md:text-base text-gray-600 mb-6 lg:mb-8 max-w-xl">
                  With Microsoft For Startups as our partner, we are rolling out
                  new features and events everytime. Subscribe to our newsletter
                  to stay updated.
                </p>
